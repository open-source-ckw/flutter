...
class _UpiViewState extends State<UpiView> {
  final upiController = Get.put(UpiController());
  ...
  Future<UpiResponse> initiateTransaction(UpiApp app) async {
    if(passData != null){
      return _upiIndia.startTransaction(
        app: app,
        receiverUpiId: passData['settings']['vpa']['value'],
        receiverName: passData['settings']['name']['value'],
