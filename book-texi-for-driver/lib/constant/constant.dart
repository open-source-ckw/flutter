...
class Constant {
  ...
  static Rx<LocationLatLng> currentLocation = LocationLatLng().obs;
  ...
  static const globalUrl = "https://goride.thatsend.net/";

  static const userPlaceHolder =
      "https://firebasestorage.googleapis.com/v0/b/driverapp-b9e74.appspot.com/o/user_dummy_image.png?alt=media&token=a34e5fc0-6e6e-4f4b-a5a9-dcc1ad8c3494";
  ...
  static Future<DateTime?> selectFeatureDate(BuildContext context) async {
