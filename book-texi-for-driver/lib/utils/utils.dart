  ...
  static Future<Position> determinePosition() async {
    ...
    if(permission == LocationPermission.whileInUse){
      Get.defaultDialog(
        ...
        title: "Permission is allowed only for using an app",
        middleText: "Continue access to your location, Please allow the permission 'Allow all the time'",
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        ...
        Get.defaultDialog(
          ...
          middleText: "Continue access to your location",
          backgroundColor: Colors.black,
          titleStyle: TextStyle(color: Colors.white),
          middleTextStyle: TextStyle(color: Colors.white),
          textCancel: "Cancel".tr,
    ...
    Constant.currentLocation.value = LocationLatLng(
