                                ...
                                children: [
                                  GoogleMap(
                                    ...
                                    initialCameraPosition: CameraPosition(
                                      zoom: 15,
                                      target: LatLng(
                                          Constant.currentLocation.value.latitude ??
                                              45.521563,
                                          Constant.currentLocation.value.longitude ??
                                              -122.677433),
                                    ),
                                  ),
                                  Align(
                                                            ...
                                                            .sendOneNotification(
                                                                ...
                                                                title:
                                                                    'New Driver Bid'
                                                                        .tr,
                                                                body:
                                                                    'Driver has offered ${Constant.amountShow(amount: controller.newAmount.value)} for your journey.🚗'
                                                                        .tr,
                                                                payload: playLoad);
                                                      }
                                                    });
                                  ...
                                  Padding(
                                    ...
                                    child: Align(
                                      ...
                                      child: FloatingActionButton(onPressed: (){Get.back();}, mini: true, child: Icon(Icons.arrow_back, color: Colors.white,), backgroundColor: Colors.black45, ),
                                    ),
                                  )
                                ],
                              ),
