...
class NewOrderFreightScreen extends StatelessWidget {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              if (Constant.distanceType == "Km") {
                                amount = Constant.amountCalculate(
                                        orderModel.freightVehicle!.kmCharge
                                            .toString(),
                              ...
                              return InkWell(
                                onTap: () {
                                  if (orderModel.acceptedDriverId != null &&
                                    ...
                                    offerAcceptDialog(context, controller,
                                        orderModel, themeChange);
                                  }
                                },
                                child: Padding(
  ...
  offerAcceptDialog(BuildContext context, FreightController controller,
      InterCityOrderModel orderModel, DarkThemeProvider themeChange) {
