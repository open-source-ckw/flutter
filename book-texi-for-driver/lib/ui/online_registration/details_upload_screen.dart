...
class DetailsUploadScreen extends StatelessWidget {
        ...
        builder: (controller) {
          return Scaffold(
            ...
            appBar: AppBar(
              ...
              // elevation: 0,
              // centerTitle: true,
              title: Text(controller.documentModel.value.title.toString(),
                            ...
                            child: Column(
                              children: [
                                ...
                                Visibility(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      await Constant.selectFeatureDate(context)
                                          .then((value) {
                                        if (value != null) {
  ...
  buildBottomSheet(BuildContext context, DetailsUploadController controller,
      String type, DarkThemeProvider themeChange) {
