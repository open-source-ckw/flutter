  ...
  updateCurrentLocation() async {
    ...
    if (permissionStatus == PermissionStatus.granted) {
      ...
      location.changeSettings(
          ...
          interval: 2000);
      await location.onLocationChanged.listen((locationData) async {
        Constant.currentLocation.value = LocationLatLng(
            latitude: locationData.latitude, longitude: locationData.longitude);
        //Constant.currentLocations.value = LatLng(locationData.latitude!.toDouble(), locationData.longitude!.toDouble());
