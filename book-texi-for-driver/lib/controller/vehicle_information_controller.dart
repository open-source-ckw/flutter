...
class VehicleInformationController extends GetxController {
  ...
  getVehicleTye() async {
    ...
    await FireStoreUtils.getDriverProfile(FireStoreUtils.getCurrentUid())
      ...
      print(driverModel.value.vehicleInformation);
      if (driverModel.value.vehicleInformation != null) {
        ...
        selectedDate.value = (driverModel.value.vehicleInformation!.registrationDate != null) ? driverModel.value.vehicleInformation!.registrationDate!.toDate() : DateTime.now();
