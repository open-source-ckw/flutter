...
class LoginController extends GetxController {
  ...
  Future<UserCredential> signInWithApple() async {
    ...
    if (appleCredential.givenName != null) {
      Preferences.setString(Preferences.signInWithAppleDisplayName,
          "${appleCredential.givenName} ${appleCredential.familyName}");
      Preferences.setString(
          Preferences.signInWithAppleEmail, "${appleCredential.email}");
    }
  ...
  Future<UserCredential> signInWithAppleBackup() async {
    // var redirectURL = "https://cabme-pro.firebaseapp.com/__/auth/handler";
    // var clientID = "AS_PER_THE_DOCS";
