...
class InterCityScreen extends StatelessWidget {
   InterCityScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<InterCityController>(
      ...
      builder: (controller) {
        return Scaffold(
          // backgroundColor:
          //     themeChange.getThem() ? AppColors.primary : AppColors.background,
                                        ...
                                        child: TextFieldThem
                                          ...
                                          prefix: Padding(
                                            ...
                                            child: Text(Constant
                                                ...
                                                .toString(),style: GoogleFonts.poppins(color: themeChange.getThem() ? Colors.white : Colors.black,),),
                                          ),
                                        )),
                                  ),
                                  const SizedBox(
                                                      ...
                                                      Expanded(
                                                        ...
                                                        controller
                                                            ...
                                                            : controller
                                                                ...
                                                                .toString(),
                                                        style: GoogleFonts
                                                            .poppins(color: themeChange.getThem() ? Colors.white : Colors.black,),
                                                      )),
                                                      const Icon(Icons
                                                          .arrow_drop_down_outlined)
                                                    ],
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                ...
                                style: GoogleFonts.poppins(
                                    fontSize: 16, fontWeight: FontWeight.w600,color: themeChange.getThem() ? Colors.white : Colors.black,),
                              ),
                            ),
                            const SizedBox(
                              width: 10,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () async {
                            /// This code write using "fluttercontactpicker" package but now this is discontinued.
    ...
    final action = CupertinoActionSheet(
      ...
      actions: <Widget>[
        CupertinoActionSheetAction(
          ...
          child: Text('Choose image from gallery'.tr,style: GoogleFonts.poppins(),),
        ),
        CupertinoActionSheetAction(
