...
class HomeScreen extends StatelessWidget {
                                    ...
                                    ButtonThem.buildButton(
                                      ...
                                      onPress: () async {
                                        ...
                                        if (controller.selectedPaymentMethod
                                          ...
                                          showAlertDialog(context, themeChange);
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          print("airPortModel.airportName");
                          print(airPortModel.airportName);
  ...
  showAlertDialog(BuildContext context, DarkThemeProvider themeChange) {
    // set up the button
    Widget okButton = TextButton(
      child: Text(
        "OK",
        style: GoogleFonts.poppins(color: AppColors.darkModePrimary),
      ),
      onPressed: () {
        Get.back();
      },
