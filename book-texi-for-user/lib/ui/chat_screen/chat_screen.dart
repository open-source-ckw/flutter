                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        ...
                        icon: Icon(Icons.send_rounded, color: themeChange.getThem() ? Colors.white : Colors.black,),
                      ),
                      prefixIcon: IconButton(
                        onPressed: () async {
                          _onCameraClick();
                        },
                        icon: Icon(Icons.camera_alt, color: themeChange.getThem() ? Colors.white : Colors.black,),
                      ),
                ...
                Column(
                  ...
                  children: [
                    Text(widget.customerName.toString(),
                        style: GoogleFonts.poppins(
                            fontSize: 12, fontWeight: FontWeight.w400,color: themeChange.getThem() ? Colors.white : Colors.black,)),
                    Text(Constant.dateAndTimeFormatTimestamp(data.createdAt),
                        style: GoogleFonts.poppins(
                            fontSize: 12, fontWeight: FontWeight.w400,color: themeChange.getThem() ? Colors.white : Colors.black,)),
                  ],
