...
class DashBoardController extends GetxController {
  final drawerItems = [
    ...
    DrawerItem('Rides'.tr, "assets/icons/ic_order.png"),
    DrawerItem('OutStation Rides'.tr, "assets/icons/ic_order.png"),
    DrawerItem('My Wallet'.tr, "assets/icons/ic_wallet.png"),
    DrawerItem('Settings'.tr, "assets/icons/ic_settings.png"),
    DrawerItem('Referral a friends'.tr, "assets/icons/ic_referral.png"),
    DrawerItem('Inbox'.tr, "assets/icons/ic_inbox.png"),
    DrawerItem('Profile'.tr, "assets/icons/ic_profile.png"),
    DrawerItem('Contact us'.tr, "assets/icons/ic_contact_us.png"),
    DrawerItem('FAQs'.tr, "assets/icons/ic_faq.png"),
    ...
    if(Preferences.getBoolean(Preferences.backgroundLocationAccess) == true){
      ...
      new Future.delayed(Duration.zero, () {
        Get.defaultDialog(
          ...
          middleText: "WayFinder collects location data to enable tracking your trips to work and calculate distance travelled even when the app is closed or not in use.",
