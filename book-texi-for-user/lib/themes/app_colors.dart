...
class AppColors {
  ...
  // static const Color buttonColor = Color(0xff72e316);
  static const Color darkModePrimary = Color(0xff1fa5f8);
  // static const Color darkModePrimary = Color(0xffffb104);
  // static const Color darkModePrimary = Color(0xff68c702);
