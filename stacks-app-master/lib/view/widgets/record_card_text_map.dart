...
class RecordCardTextMap extends StatelessWidget {
  final String id;
  final double rating;
  final String title;
  ...
  RecordCardTextMap({Key? key, required this.id, this.rating = 0, required this.title, required this.content, required this.date, required this.link, required this.faviconUrl})
      : super(key: key);
