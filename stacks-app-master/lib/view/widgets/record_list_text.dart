...
class RecordListText extends StatelessWidget {
  final String id;
  final double rating;
  final String title;
  ...
  RecordListText({Key? key, required this.id, this.rating = 0, required this.title, required this.content, required this.date, required this.link, required this.faviconUrl})
      : super(key: key);
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Icon(Icons.info, size: 15, color: primaryColor),
                              ),
                            ],
                          ),
                        ),
