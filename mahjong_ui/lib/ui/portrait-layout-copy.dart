...
class PortraitMahjongTableScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final topGrid = ["circle_1.png", "circle_5.png", "char_2.png", "dragon_red.png", "circle_3.png", "dragon_green.png", "flower_1.png", "circle_7.png", "char_7.png", "wind_noth.png", "dragon_white.png", "bamboo_1.png", "bamboo_2.png", "wind_west.png", "flower_3.png", "circle_5.png"]; // pretend discard/wall area
    ...
    final bottomHand = ["wind_suth.png", "wind_east.png", "wind_east.png", "wind_west.png", "wind_noth.png", "char_7.png", "char_8.png", "char_6.png", "char_9.png", "circle_3.png", "circle_4.png", "circle_5.png", "circle_6.png"];
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, c) {
            ...
            final railW = (w * 0.05).clamp(50.0, 80.0);      // turquoise rails
            //final railW = 50.0;
            final innerPad = 10.0;
            ...
            final rackTileW = (tileW * 0.96).clamp(36.0, 58.0);
            // final rackTileH = rackTileW * 1.28;
            final rackTileH = rackTileW * 1.06;
